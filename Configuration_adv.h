...
//
  ...
  //#define FAN2_PIN                   -1   // Remove the fan signal on pin P2_04 (example: SKR 1.4 Turbo HE1 plug)

  #define CHAMBER_FAN               // Enable a fan on the chamber
  #if ENABLED(CHAMBER_FAN)
    #define CHAMBER_FAN_INDEX   2   // Index of a fan to repurpose as the chamber fan. (Default: first unused fan) Currently FAN2_
    #define CHAMBER_FAN_MODE      3   // Fan control mode: 0=Static; 1=Linear increase when temp is higher than target; 2=V-shaped curve; 3=similar to 1 but fan is always on.
      ...
      #define CHAMBER_FAN_FACTOR 51   // PWM increase per °C above target
    #elif CHAMBER_FAN_MODE == 2
      #define CHAMBER_FAN_BASE  128   // Minimum chamber fan PWM (0-255)
      #define CHAMBER_FAN_FACTOR 25   // PWM increase per °C difference from target
    #elif CHAMBER_FAN_MODE == 3
      #define CHAMBER_FAN_BASE  0   // Base chamber fan PWM (0-255)
      #define CHAMBER_FAN_FACTOR 255   // PWM increase per °C above target
    #endif
  #endif
...
//#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN          // Set a custom pin for the controller fan
 ...
 */
#define FAN_MIN_PWM 200 //Minimum value to make fan spin
 ...
 */
#define E0_AUTO_FAN_PIN PE5 //Fan1
...
#define CHAMBER_AUTO_FAN_PIN -1 //auto assigned to Fan2
#define COOLER_AUTO_FAN_PIN -1
#define COOLER_FAN_PIN -1 //auto assigned to Fan0?
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  50, 178 }, { 300,  178 } }//, { 190, 190 } }
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT_HOME  500  // (mA) RMS current for sensorless homing, changed from "X_CURRENT_HOME X_CURRENT"
    ...
    #define Y_CURRENT_HOME  500 // Changed from "Y_CURRENT_HOME Y_CURRENT"
    #define Y_MICROSTEPS     16
  ...
  //Each stepper has it's on software serial pins on the SKR Pro,
  //so normally you would leave these all with the default 0 value and remove all the jumpers underneath the stepper driver.

  #define  X_SLAVE_ADDRESS 0 //0
  #define  Y_SLAVE_ADDRESS 0 //2
...
//Place to add EMG-STOP to pushbutton on control cabinet.
...
//#define CUSTOM_USER_BUTTONS
  ...
  //#define BUTTON1_PIN -1
    ...
    #define BUTTON1_GCODE         "M410"
    #define BUTTON1_DESC          "Full stop"  // Optional string to set the LCD status
  #endif
